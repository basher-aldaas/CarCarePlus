...
class ServiceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $services = [
            ...
            ['category_id' => $maintenanceId, 'name' => 'Oil Change Maintenance', 'name_ar' => 'تغيير زيت', 'description' => 'تغيير زيت المحرك والفلتر', 'base_price' => 120, 'is_vip_available' => false, 'vip_extra_price' => null, 'duration_minutes' => 45],
