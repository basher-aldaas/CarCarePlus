...
class ServiceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $services = [
            ...
            ['category_id' => $maintenanceId,'name' => 'Wheel Balancing','name_ar' => 'ترصيص إطارات','description' => 'ضبط توازن العجلات والإطارات لتقليل الاهتزاز أثناء القيادة','base_price' => 80,'is_vip_available' => false,'vip_extra_price' => null,'duration_minutes' => 30],
