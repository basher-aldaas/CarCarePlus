...
class OrderDTO
{
    public function __construct(
        ...
        public ?int $user_package_id,
        public ?float $package_covered_amount,
        public ?float $cash_due_amount,
        public ?string $notes,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            user_package_id: isset($data['user_package_id']) ? (int) $data['user_package_id'] : null,
            package_covered_amount: isset($data['package_covered_amount']) ? (float) $data['package_covered_amount'] : null,
            cash_due_amount: isset($data['cash_due_amount']) ? (float) $data['cash_due_amount'] : null,
