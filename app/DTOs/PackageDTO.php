...
class PackageDTO
{
    public function __construct(
        ...
        public ?string $type,
        public ?bool $is_company_package,
        public ?float $price,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            type: $data['type'] ?? null,
            is_company_package: isset($data['is_company_package']) ? (bool) $data['is_company_package'] : null,
    ...
    public function toArray(): array
    {
        return array_filter([
            ...
            'type' => $this->type,
            'is_company_package' => $this->is_company_package,
            'price' => $this->price,
